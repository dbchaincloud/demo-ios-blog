...
extension UIFont {
    public struct ThemeFont {
        ...
        public static var H2Medium :UIFont { return UIFont.systemFont(ofSize: 20, weight:.medium)}
        public static var H2Bold :UIFont { return UIFont.systemFont(ofSize: 20, weight:.bold)}
        public static var H2Regular :UIFont { return UIFont.systemFont(ofSize: 20, weight:.regular)}
